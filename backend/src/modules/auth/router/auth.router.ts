...
import { loginSchema, registerSchema, simpleRegisterSchema } from '../dto/auth.dto';
 ...
 * /auth/register:
 *   post:
 *     summary: Register a new user (Simple version for tests)
 *     tags: [Authentication]
 *     requestBody:
 *       required: true
 *       content:
 ...
 * /auth/register-full:
 *   post:
 *     summary: Register a new user (Full version for application)
 *     tags: [Authentication]
 *     requestBody:
 *       required: true
 *       content:
